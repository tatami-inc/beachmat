...
void load_character(void *, size_t, size_t, Rcpp::String*);
...
void load_const_col_character(void *, size_t, Rcpp::StringVector::iterator*, size_t, size_t, Rcpp::StringVector::iterator*);
