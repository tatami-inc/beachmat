...
void load_integer(void * ptr, size_t r, size_t c, int* val) {
...
void load_const_col_integer(void* ptr, size_t c, Rcpp::IntegerVector::iterator* it, size_t first, size_t last, Rcpp::IntegerVector::iterator* out) {
