...
public:
    external_reader_base(const Rcpp::RObject& incoming) : original(incoming) {
        ...
        auto load_name=get_external_name(classinfo, type, "input", "get");
        load=reinterpret_cast<void (*)(void *, size_t, size_t, T*)>(R_GetCCallable(pkg, load_name.c_str()));

        auto load_const_name=get_external_name(classinfo, type, "input", "getConstCol");
        ...
        auto load_const_indexed_name=get_external_name(classinfo, type, "input", "getConstColIndexed");
        ...
        auto get_dim_name=get_external_name(classinfo, type, "input", "dim");
...
public:    
    external_lin_reader(const Rcpp::RObject& incoming) : external_reader_base<T, V>(incoming) {
        ...
        auto load_rows2int_name=get_external_name(classinfo, type, "input", "getRows", "integer");
        ...
        auto load_cols2dbl_name=get_external_name(classinfo, type, "input", "getCols", "numeric");
        ...
        auto load_rows2dbl_name=get_external_name(classinfo, type, "input", "getRows", "numeric");
