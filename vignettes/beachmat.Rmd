...
Returns a `const_col_indexed_info` object, which is a tuple consisting of:
...
This method is quite efficient for `dgCMatrix` objects, as it will directly return iterators to the indices and values of the **non-zero entries only**.
