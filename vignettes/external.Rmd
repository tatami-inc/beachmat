...
The `val` pointer should reflect the matrix type.
...
```cpp
load_const_col_integer(
    ptr, /* void* */
    c, /* size_t */
    in, /* Rcpp::IntegerVector::iterator* */
    first, /* size_t */
    last, /* size_t */
    out /* Rcpp::IntegerVector::iterator* */
);
```
...
Again, both `index` and `values` are _pointers_ to iterator objects.
