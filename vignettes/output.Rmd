---
title: "Using beachmat to output data in R matrix objects"
author: "Aaron Lun"
package: beachmat
output: 
  BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Using beachmat to output data in R matrix objects}
...
auto oimat=beachmat::create_integer_output(nrow, ncol);

// returns a std::unique_ptr<logical_output> 
auto olmat=beachmat::create_logical_output(nrow, ncol);

// returns a std::unique_ptr<character_output> 
auto ocmat=beachmat::create_character_output(nrow, ncol);
```
