...
- The lifetime of the `const_column` instance should not exceed that of the `*_matrix` with which it was constructed. 
The former keeps iterators to the underlying R-managed data, which may be invalidated in some contrived scenarios.
