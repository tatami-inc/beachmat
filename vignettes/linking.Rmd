...
This enables Bioconductor packages to use C++ for high-performance processing of data stored in an abstract R matrix representation, including:
...
- and anything with a `DelayedArray::extract_array()` method.
